...
function ItemDAO(database) {
    ...
    this.getItems = function(category, page, itemsPerPage, callback) {
        ...
        this.db.collection('item').aggregate(query).toArray(function(err, documents) {
    ...
    this.searchItems = function(query, page, itemsPerPage, callback) {
        ...
        this.db.collection('item').aggregate(aggregationQuery).toArray(function(err, documents) {
            assert.equal(err, null);
            callback(documents);
        });
    }
    ...
    this.getNumSearchItems = function(query, callback) {
        ...
        */
        ...
        var findQuery = { $text : {$search : query}};

        this.db.collection('item').find(findQuery).count(function(err, numItems) {
           callback(numItems);
       });
